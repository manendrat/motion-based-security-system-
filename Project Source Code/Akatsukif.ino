...
const char* ssid = "Pandi-Fi";
const char* password = "kek@1234";

// Use @myidbot to find out the chat ID of an individual or a group
// Also note that you need to click "start" on a bot before it can
// message you
String chatId = "1131501520";

// Initialize Telegram BOT
String BOTtoken = "5010257954:AAF_SuxFTAdh9KxwjfDn8L35i2iHkk16Vms";
...
String sendPhotoTelegram(){
  ...
  if (clientTCP.connect(myDomain, 443)) {
    ...
    clientTCP.println("Content-Type: multipart/form-data; boundary=akatsuki");
    clientTCP.println();
